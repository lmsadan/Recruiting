package com.recruiting.qa.service;

import com.recruiting.qa.dao.ProblemDao;
...
public class ProblemService {
	...
	public Page<Problem> newlist(String lablid, int page,int size){
		PageRequest pageable = PageRequest.of(page-1,size);
		return problemDao.newlist(lablid,pageable);
	};

	public Page<Problem> hotlist(String lablid, int page,int size){
		PageRequest pageable = PageRequest.of(page-1,size);
		return problemDao.hotlist(lablid,pageable);
	};

	public Page<Problem> waitlist(String lablid, int page,int size){
		PageRequest pageable = PageRequest.of(page-1,size);
		return problemDao.waitlist(lablid,pageable);
	};
